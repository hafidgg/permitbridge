...
| verified | 0 | 0% |
| needs_review | 0 | 0% |
| pending_verification | 750 | 100% |
| deprecated | 0 | 0% |
| conflicting_sources | 0 | 0% |

> Note: 0 fields carry status "verified" — meaning a **named human reviewer** has signed off. Everything else found so far is "pending_verification": a real source was read (by an AI research assistant), but no human has confirmed it yet. This distinction is deliberate — see Data Quality Rules.

## Fields by Verification Method

| Method | Count |
|---|---|
| ai_assisted_manual_research | 80 |
| official_document_review | 5 |
| cross_referenced_multiple_sources | 120 |
| none | 545 |
...
- **Fields citing an unresolved/unregistered source:** 0

## Human Review

- **Fields with real, named human review:** 0
- **Fields without human review:** 750

## Data Quality

- **Fields missing a source despite having a value:** 0 ✅ (rule holding — no field appears without a source)
- **Stale fields (unverified for >180 days):** 0
- **Fields with unresolved conflicting sources:** 0

## Conflicts (Phase 2.6)

- **Fields with a recorded conflict (resolved or not):** 1
- **Fields with a genuinely unresolved conflict:** 0
- **Official sources that have appeared on either side of a conflict:** New York State Education Department, Office of the Professions
